...
describe('Test Integration', () => {
  const defaultComplains = {
    ...
    title: 'Corte Ilegal',
    description: 'Lorem ipsum massa lacus justo diam molestie vulputate, luctus dolor fermentum habitant dictum et, taciti dapibus consectetur cras metus curabitur. feugiat ut odio nec nostra enim adipiscing aenean lectus elit, risus rutrum torquent augue posuere mi eu turpis',
    locale: {
      city: 'São Luís',
      state: 'Maranhão',
      uf: 'MA',
